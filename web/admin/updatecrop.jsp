...
<%
  if(session.getAttribute("user")!= null)
  {
   ...
   ResultSet resultSet=database.updateCrop(id);
    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(../images/banner1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">Update Crop Prices</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <form action="../UpdateCrop" method="post" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fullname" required class="form-control" name="crop_name" value=" <%= resultSet.getString(2)%>">
                    <label class="font-weight-bold" for="fullname">New Price</label>
                  <input type="text" id="fullname"  required class="form-control" name="new_price" value=" <%= resultSet.getInt(3)%>">
                
                   <input type="hidden" id="fullname" class="form-control" name="price" value=" <%= resultSet.getInt(3)%>">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Update Rate" class="btn btn-primary text-white px-4 py-2">
                </div>
              </div>
