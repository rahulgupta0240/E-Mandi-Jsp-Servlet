    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(../images/banner1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">Add New Crop Price</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <form action="../AddCrop" method="post" enctype="multipart/form-data" class="p-5 bg-white">

              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">Crop Name</label>
                  <input type="text" id="fullname" class="form-control" name="crop_name" required placeholder="Crop Name">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">Price</label>
                  <input type="text" id="fullname" class="form-control" name="price" required placeholder="Crop Price">
                </div>
              </div>
            ...
            <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="file" id="fullname" name="file"  class="form-control">
                </div>
              </div>
            
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Add Crop" class="btn btn-primary text-white px-4 py-2">
                </div>
              </div>
