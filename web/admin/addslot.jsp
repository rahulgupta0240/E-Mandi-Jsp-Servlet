    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(../images/hd2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">Add New Slot</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <form action="../AddSlot" method="post" class="p-5 bg-white">

              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">Crop Name</label>
                  <input type="text" id="fullname" required class="form-control" name="crop_name" placeholder="Crop Name">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">Date</label>
                  <input type="date" id="fullname" required class="form-control" name="date" placeholder="Slot Date">
                </div>
              </div>
                    <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <select name="slot" class="form-control">
                    ...
                    <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">No of Slot</label>
                  <input type="number" id="fullname" required class="form-control" name="snumber" placeholder="Slot Number">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Add Slot" class="btn btn-primary text-white px-4 py-2">
                </div>
              </div>
