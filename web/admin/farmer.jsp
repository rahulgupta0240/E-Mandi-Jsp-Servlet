...
<html lang="en">
  ...
  <div class="site-wrap">
              ...
              <nav class="site-navigation text-right" role="navigation">
                <div class="container">
                  ...
                  <ul class="site-menu js-clone-nav d-none d-lg-block">
                    ...
                    <li class="active"><a href="farmer.jsp">Farmers Details</a></li>
    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(../images/hd3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">Farmer Details</h1>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    ...
    <input id="myInput" type="text" placeholder="Search Farmer Details" style="height:50px; padding:4px; width:35%; border:1px solid #555; margin:10px 0px 10px 50%; font-family:Trebuchet MS; "  />
    
      
        <div class="row">
        <%
                            
                         ResultSet resultSet=database.getFarmerDetails();
        ...
        while (resultSet.next()) {      
          ...
          <div class="col-lg-4 " id="customers">
            <div class="p-4 mb-3 bg-white tr">
              <h3 class="h5 text-black mb-3"><%= resultSet.getString(2)%></h3>
              <p class="mb-0 font-weight-bold">Username</p>
              <p class="mb-0"><%= resultSet.getString(3)%></p>
              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-0"><a href=""><%= resultSet.getString(5)%></a></p>
                    <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href=""><%= resultSet.getString(8)%></a></p>
                    <p class="mb-0 font-weight-bold">Address</p>
              <p class="mb-0"><a href=""><%= resultSet.getString(9)%></a></p>
