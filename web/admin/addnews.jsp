    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(../images/news.png);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">Add News & Update</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <form action="../AddUpdate" method="post" enctype="multipart/form-data" class="p-5 bg-white">

              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">News Title</label>
                  <input type="text" id="fullname" class="form-control" required name="title" placeholder="News Title">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="description" id="message"  required  cols="30" rows="5" class="form-control" placeholder="Want to share any update, Write here"></textarea>
                </div>
              </div>
<div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
            ...
            <div class="row form-group">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Add News" class="btn btn-primary text-white px-4 py-2">
                </div>
              </div>
