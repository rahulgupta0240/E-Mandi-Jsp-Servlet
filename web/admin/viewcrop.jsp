  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(../images/banner1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">Update Crop Price</h1>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12">
            <h2 class="site-section-heading text-center text-uppercase"></h2>
          </div>
        </div>
        <div class="row">
              <%
        ...
        while (resultSet.next()) {      
          ...
          <div class="col-md-4 text-center mb-4 pop">
            ...
            %>
                 ...
                 <div class="content-details Bpop">
								        <h4 class="content-title mx-auto text-uppercase">
                                                                            <p>
                                                                        <a href="updatecrop.jsp?id=<%= resultSet.getInt(1)%>" ><span class="d-inline-block p-3 bg-primary text-white btn btn-primary">Update</span></a>		
					                                <a href="../DeleteCrop?id=<%= resultSet.getInt(1)%>" ><span class="d-inline-block p-3 bg-primary text-white btn btn-primary">Delete</span></a>		
					                              </h4>
                                                                          </p>
                                            </p>
								      </div>
