    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(../images/news.png);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">View & Update NewsFeed</h1>
                ...
                <p><%= resultSet.getString(3)%></p>
                    ...
                    <div class="content-details Bpop">
								        <h4 class="content-title mx-auto text-uppercase">
                                                                            <p>
                                                                        <a href="updatenews.jsp?id=<%= resultSet.getInt(1)%>" ><span class="d-inline-block p-3 bg-primary text-white btn btn-primary">Update</span></a>		
					                                <a href="../DeleteNews?id=<%= resultSet.getInt(1)%>" ><span class="d-inline-block p-3 bg-primary text-white btn btn-primary">Delete</span></a>		
					                              </h4>
                                                                          </p>
                                            </p>
								      </div>
