  ...
  <div class="site-wrap">
   ...
   <ul class="site-menu js-clone-nav d-none d-lg-block">
                    <li ><a href="index.jsp">Home</a></li>
                     ...
                     <li class="active"><a href="viewslot.jsp">View Booked Slot</a></li>
    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(../images/hd5.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">Your Booked Slots</h1>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    ...
    <div class="site-section">
      <div class="container">
          <input id="myInput" type="text" placeholder="Search By Crop Name or Date or Time" style="height:30px; padding:4px; width:35%; border:1px solid #555; margin:10px 0px 10px 50%; font-family:Trebuchet MS; "  />
                               
        <div class="row mb-5">
                 <%
                     String user=session.getAttribute("user").toString();
                     ResultSet resultSet1=database.getUser(user);
                        resultSet1.next(); 
                        int fid=resultSet1.getInt(1);
                     
                     ResultSet resultSet=database.getSlotDetails(fid);

                         ResultSetMetaData resultSetMeta=resultSet.getMetaData();
        while (resultSet.next()) {      
            %>
            
          <div class="col-md-6 col-lg-4 mb-5 pop" id="customers" >
            <div class="media-image">
              <div class="media-image-body tr" >
                  <table > <tr>
                          <th class="font-secondary text-uppercase" >
                              Crop: 
                       ...
                       <tr>
                          <td class="font-secondary text-uppercase">
                              date: 
