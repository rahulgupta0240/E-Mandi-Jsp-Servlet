    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(../images/hd2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">Book Your Slot </h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <form action="bookslot_2.jsp" method="post" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="date" id="fullname" class="form-control" name="date" required placeholder="Slot Date">
                </div>
              </div>
                    <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Check Slots" class="btn btn-primary text-white px-4 py-2">
                </div>
              </div>
