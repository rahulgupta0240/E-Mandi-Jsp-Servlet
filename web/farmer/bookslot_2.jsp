...
<html lang="en">
  ...
  <div class="site-wrap">
                ...
                <div class="container">
                  <div class="d-inline-block d-lg-none ml-md-0 mr-auto py-3"><a href="#" class="site-menu-toggle js-menu-toggle text-black"><span class="icon-menu h3"></span></a></div>
                    ...
                    <li><a href="index.jsp">Home</a></li>
                     ...
                     <li class="active"><a href="bookslot.jsp">Book Slot</a></li>
    ...
    <div class="site-blocks-cover inner-page overlay" style="background-image: url(../images/hd2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-7 text-center" data-aos="fade">
          <h1 class="text-uppercase">Book Slot and Sell Crop </h1>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12">
            <h2 class="site-section-heading text-center text-uppercase">Your Details</h2>
          </div>
        </div>
        <div class="row">
              <%
                  String c_name=request.getParameter("crop_name");
                  String date=request.getParameter("date");
                  String time=request.getParameter("slot");
                  
                          ResultSet resultSet=database.checkSlot(c_name,date,time);
                         ...
                         <script type="text/javascript">
                             ...
                             window.location="bookslot.jsp";
                                ...
                                <div class="row mb-5">
          <div class="col-md-12">
            <h2 class="site-section-heading text-center text-uppercase">Sorry! This Slot is Not Available.</h2>
          </div>
        </div>
            ...
            <script type="text/javascript">
                             ...
                             alert ("Sorry! No Slots Available for Selected Time & Date .");
                             window.location="bookslot.jsp";
                         </script>
            <div class="row mb-5">
          <div class="col-md-12">
            <h2 class="site-section-heading text-center text-uppercase">Sorry! No Slots Available for Selected Time & Date .</h2>
          </div>
        </div>
 ...
 String farmer=session.getAttribute("user").toString();
                  
                          ResultSet resultSet_2=database.getFarmer(farmer);

                         ResultSetMetaData resultSetMeta_2=resultSet_2.getMetaData();  
resultSet_2.next();
              %>
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <form action="../BookSlot" method="post" class="p-5 bg-white">

              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                     <input type="hidden" id="fullname" class="form-control" name="fid" value="<%= resultSet_2.getInt(1) %>"/>
                     <input type="hidden" id="fullname" class="form-control" name="sid" value="<%= resultSet.getInt(1) %>"/>
                <input type="hidden" id="fullname" class="form-control" name="snumber" value="<%= resultSet.getInt(4) %>"/>
              
                  <label class="font-weight-bold" for="fullname">Farmer Name</label>
                  <input type="text" id="fullname" class="form-control" name="fname" value="<%= resultSet_2.getString(2) %>" disabled/>
                </div>
              </div>
                <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">city</label>
                  <input type="text" id="fullname" class="form-control" name="city" disabled value="<%= resultSet_2.getString(6) %>"/>
                </div>
              </div>
                <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">Mobile</label>
                  <input type="text" id="fullname" class="form-control" disabled name="mobile" value="<%= resultSet_2.getString(5) %>"/>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="fullname">address</label>
                  <input type="text" id="fullname" class="form-control" disabled name="address" value="<%= resultSet_2.getString(9) %>">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Book Slot" class="btn btn-primary text-white px-4 py-2">
                </div>
              </div>
